...
const LANGS = ['en', 'es', 'pt', 'fr', 'it', 'de', 'pl', 'uk', 'tr', 'id',
  'zh', 'ja', 'ko', 'vi', 'hi', 'ar', 'bn', 'uz', 'kk'];
...
const SAME_AS_SOURCE_OK = {
  '*': {
    '—': 'в строке нет слов: это прочерк, он одинаков во всех языках',
    '+{v0} 💎': 'в строке нет слов: число, плюс и эмодзи одинаковы во всех языках',
    '{v0} · +{v1} 💎': 'в строке нет слов: два числа, точка-разделитель и эмодзи',
    '{v0}, {v1}': 'в строке нет слов: две подстановки и запятая',
    '{v0} {v1}': 'в строке нет слов: число и уже переведённая форма слова через пробел',
  },
  kk: {
    'Медаль: {v0} · +{v1} 💎': 'қазақша да «медаль», қалғаны — сандар мен эмодзи',
    'Профиль': 'қазақ тілінде де «профиль»',
    /* Ағылшын жалғаулары қазақ тіліне орыс тілі арқылы дәл сол күйінде
       кірген. Сәйкестік шын, сондықтан аудармасы да сол. */
    '-tion → -ция': 'қазақ тілінде де -ция: информация, станция',
    '-sion → -сия': 'қазақ тілінде де -сия: версия, телевизия',
    '-ist → -ист': 'қазақ тілінде де -ист: турист, артист',
    '-ism → -изм': 'қазақ тілінде де -изм: капитализм, реализм',
    'ph → ф': 'қазақ әліпбиіндегі ф — дәл сол әріп',
    'c → к': 'қазақ әліпбиіндегі к — дәл сол әріп',
  },
  uk: {
    /* Літери ті самі в обох абетках: підміняти їх нічим. */
    'ph → ф': 'українська «ф» — та сама літера',
    'c → к': 'українська «к» — та сама літера',
    ...
    'день': 'українською теж «день»: слово спільне',
    'Чисто': 'українською теж «чисто»',
    'Сотня': 'українською теж «сотня»',
    'Рамка': 'українською теж «рамка»',
    'Без рамки': 'обидва слова спільні для двох мов',
    'Без шапки': 'обидва слова спільні для двох мов',
    'На голову': 'обидва слова спільні для двох мов',
    'Заморозка дня': 'обидва слова спільні для двох мов',
    'Каска': 'назва предмета збігається',
    'Кепка': 'назва предмета збігається',
    'Корона': 'назва предмета збігається',
    'Шарф': 'назва предмета збігається',
    'Космонавт': 'назва збігається',
    'Лис': 'назва тварини збігається',
    'Панда': 'назва тварини збігається',
    'Сова': 'назва тварини збігається',
    'Слива': 'назва збігається',
    'Океан': 'назва збігається',
    'Медаль: {v0} · +{v1} 💎': 'слово «медаль» спільне, решта — підстановки й емодзі',
  },
};
