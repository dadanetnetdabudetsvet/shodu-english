...
export const QUEST_POOL = [
  ...
  { id: 'clean',    icon: '🎯', title: 'Чисто',                need: 1,  gems: 20, unit: 'clean',    any: true,
    hint: 'Занятие без единого промаха' },
  ...
  { id: 'build',    icon: '🧱', title: 'Своими руками',        need: 1,  gems: 25, unit: 'mode:phrase',
    hint: 'Собрать хотя бы одну фразу' },
  ...
  { id: 'rules',    icon: '💡', title: 'Разобрать правило',    need: 1,  gems: 15, unit: 'rules',
    hint: 'Открыть и дочитать одно правило' },
  { id: 'goal',     icon: '🏁', title: 'Дневная цель',         need: 1,  gems: 20, unit: 'goal',     any: true,
    hint: 'Закрыть цель дня' },
];
...
export const ACTIVITIES = [
  { id: 'a01', icon: '📘', title: 'Обычное занятие',        sub: 'новые слова и повторение', route: 'session/build' },
  ...
  { id: 'a05', icon: '👁', title: 'Поймать подмену',         sub: 'читать быстрее',           route: 'stream' },
  ...
  { id: 'a08', icon: '🪤', title: 'Изучить ловушки',         sub: 'слова, которые обманывают', route: 'words', param: 'traps' },
  { id: 'a09', icon: '🌱', title: 'Заглянуть в новые слова', sub: 'то, что ещё впереди',      route: 'words', param: 'new' },
  { id: 'a10', icon: '💡', title: 'Прочитать одно правило',  sub: 'там, где всё как у нас',   route: 'rules' },
  { id: 'a11', icon: '🎚', title: 'Подвинуть сложность',     sub: 'если стало скучно или туго', route: 'profile' },
  ...
  { id: 'a16', icon: '🏅', title: 'Проверить медали',        sub: 'что уже открыто',          route: 'profile' },
